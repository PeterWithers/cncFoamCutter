...
//        final int tipGcodeWash = (int) ((double) wingData.getTipWash() / wingData.getWingLength() * machineData.getWireLength());
        ...
        float tipPercentOfWire = (float) bedAlignmentCalculator.getTipPosition() / machineData.getWireLength();
        float rootPercentOfWire = (float) bedAlignmentCalculator.getRootPosition() / machineData.getWireLength();
        ...
        model.addAttribute("rootAerofoilSvg", tipAerofoilData.toSvgPoints(machineData.getInitialCutLength() + (int) (machineData.getViewAngle() * rootPercentOfWire), (int) ((machineData.getMachineHeight() - machineData.getInitialCutHeight()) + (machineData.getWireLength() - machineData.getViewAngle()) * (rootPercentOfWire)), wingData.getRootChord(), bedAlignmentCalculator.getRootSweep(), bedAlignmentCalculator.getRootWash()));
