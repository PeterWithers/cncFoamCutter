...
public class BedAlignmentTest {
    ...
    public void testGetExtrapolatedSpeed() {
        ...
        assertEquals(machineData.getCuttingSpeed() * 2, instance.getExtrapolatedSpeed(new GcodeMovement(10, 10, 10, 10, 0, 0, 0), 8, 8, 10, 10).speed, 0.0);
        ...
        assertEquals(machineData.getCuttingSpeed() * 2, instance.getExtrapolatedSpeed(new GcodeMovement(10, 10, 10, 10, 0, 0, 0), 10, 10, 8, 10).speed, 0.0);
        assertEquals(machineData.getCuttingSpeed() * 2, instance.getExtrapolatedSpeed(new GcodeMovement(10, 10, 10, 10, 0, 0, 0), 8, 10, 10, 10).speed, 0.0);
        assertEquals(machineData.getCuttingSpeed() * 2, instance.getExtrapolatedSpeed(new GcodeMovement(10, 10, 10, 10, 0, 0, 0), 10, 8, 10, 10).speed, 0.0);
        ...
        assertEquals(machineData.getCuttingSpeed(), instance.getExtrapolatedSpeed(new GcodeMovement(10, 8, 8, 10, 0, 0, 0), 10, 10, 10, 10).speed, 0.0);
